...
public class ContactService {
    ...
    public void sendContactEmail(String nom, String prenom ,String email, String sujet,
                                 String phone, String message) {
        try {
            MimeMessage mime = mailSender.createMimeMessage();
            MimeMessageHelper helper = new MimeMessageHelper(mime, true, "UTF-8");

            helper.setTo("comar2866@gmail.com");
            helper.setFrom("comar2866@gmail.com", nom); // ✅ nom affiché comme expéditeur
            ...
            String htmlContent =
                    "<div style='font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #f9f9f9; padding: 30px;'>" +
                            ...
                            "<td style='padding: 12px 0; color: #9ca3af; font-size: 13px; width: 120px;'>👤 Nom et prénom</td>" +
                            "<td style='padding: 12px 0; color: #111827; font-weight: 600;'>" + nom + prenom + "</td>" +
                            "</tr>" +
                            "<tr style='border-bottom: 1px solid #f0f0f0;'>" +
